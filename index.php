...
$cart = generate_cart();
$title = "Jslave Glassy";
$file = file_get_contents("views/index_tpl.php");
$header = file_get_contents("views/header_tpl.php");
$footer = file_get_contents("views/footer_tpl.php");
$products = generate_products(4,"all");
...
//отменить доьавление пустого заказа